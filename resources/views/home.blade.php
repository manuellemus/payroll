        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row ">
                        <div class="card border-secondary text-secondary warni  mb-3 col-sm-6  ">
                            <div class="card-body ">
                                <h1 class="card-title"><i class="fa fa-building"></i></h1>
                                <a href="#" class="btn btn-secondary">Departamentos</a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card border-success text-success mb-3 col-sm-6  center">
                            <div class="card-body ">
                                ...
                                <a href="#" class="btn btn-success">Salarios</a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
